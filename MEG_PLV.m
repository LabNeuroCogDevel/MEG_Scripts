...
% timecourses from 2 ROIs. For the newest implementation that calculates
% PLV from wavelet coefficiecents. Use MEG_PLV2.
...
for FOI=FOIs
    ...
    for k = 1:NumberOfTrials
        ...
        [TFR_tar,~,~]=traces2PLF(tar_event,FOI,Fs,width);
